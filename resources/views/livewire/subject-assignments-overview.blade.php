        ...
        <ul class="list-disc list-inside text-gray-700">
            ...
            @foreach ($subject->assignments as $assignment)
                <div class="py-3">
                    ...
                    @endif
                    <a href="{{ route('student.download.grade', [$subject->id, $assignment->id]) }}" class="px-6 py-3 ml-2 mt-2 bg-windesheim text-white rounded-lg shadow-md hover:bg-windesheim-hover focus:outline-none focus:ring-2 focus:ring-windesheim-focus">download</a>
                </div>
            @endforeach
        </ul>
    @else
