...
<section class="w-full">
    ...
    <x-settings.layout :heading="__('Profiel')" :subheading="__('Update uw naam en email adres')">
                    ...
                    <div>
                        <flux:text class="mt-4">
                            ...
                            <flux:link class="text-sm cursor-pointer" wire:click.prevent="resendVerificationNotification">
                                {{ __('Klik hier om de verificatie mail opnieuw te versturen') }}
                            </flux:link>
                        </flux:text>

                        @if (session('status') === 'verification-link-sent')
                            <flux:text class="mt-2 font-medium !dark:text-green-400 !text-green-600">
                                {{ __('Een nieuwe verificatielink is gestuurd naar uw email adres.') }}
                            </flux:text>
                        @endif
                    </div>
                @endif
